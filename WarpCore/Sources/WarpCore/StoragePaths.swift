...
public extension URL {
	static var warpApplicationSupport: URL {
		get throws {
			...
			let hexDirectory = appSupport.appendingPathComponent("com.benyamindamircheli.warp", isDirectory: true)
	...
	static func warpMigratedFileURL(named fileName: String) -> URL {
		let newURL = (try? warpApplicationSupport.appending(component: fileName))
	...
	static var warpModelsDirectory: URL {
		get throws {
			let modelsDirectory = try warpApplicationSupport.appendingPathComponent("models", isDirectory: true)
