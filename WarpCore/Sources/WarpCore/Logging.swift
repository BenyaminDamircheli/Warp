...
/// Shared helper for creating consistent os.Logger instances across the Warp app and WarpCore.
public enum WarpLog {
  public static let subsystem = "com.benyamindamircheli.warp"
  ...
  public enum Category: String {
    ...
    case mercuryTransform = "MercuryTransform"
  }
  ...
  public static let mercuryTransform = logger(.mercuryTransform)
}
