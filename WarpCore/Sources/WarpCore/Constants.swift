...
/// Central repository for timing thresholds and magic numbers used throughout WarpCore.
///
...
public enum WarpCoreConstants {
    ...
    ///
    /// **Used in:**
    /// - `WarpSettings`: Default value for user preference
    ...
    ///
    /// **Used in:**
    /// - `WarpSettings`: Default sound effects volume
