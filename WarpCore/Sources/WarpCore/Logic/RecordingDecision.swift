...
public struct RecordingDecisionEngine {
    ...
    /// See `WarpCoreConstants.modifierOnlyMinimumDuration` for rationale.
    public static let modifierOnlyMinimumDuration: TimeInterval = WarpCoreConstants.modifierOnlyMinimumDuration
