...
private let hotKeyLogger = WarpLog.hotKey
...
public struct HotKeyProcessor {
    ...
    public static let doubleTapThreshold: TimeInterval = WarpCoreConstants.doubleTapWindow
    ...
    public static let pressAndHoldCancelThreshold: TimeInterval = WarpCoreConstants.pressAndHoldCancelWindow
    ...
    public init(
        ...
        minimumKeyTime: TimeInterval = WarpCoreConstants.defaultMinimumKeyTime
    ) {
        self.hotkey = hotkey
