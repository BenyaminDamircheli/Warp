		...
		Section {
			Label {
				Toggle("Open on Login",
				       isOn: Binding(
				       	get: { store.warpSettings.openOnLogin },
			...
			Label {
				Toggle(
					"Show Dock Icon",
					isOn: Binding(
						get: { store.warpSettings.showDockIcon },
			...
			Label {
				Toggle("Use clipboard to insert", isOn: $store.warpSettings.useClipboardPaste)
			...
			Label {
				Toggle("Copy to clipboard", isOn: $store.warpSettings.copyToClipboard)
			...
			Label {
				Toggle(
					...
					isOn: Binding(
						get: { store.warpSettings.preventSystemSleep },
			...
			Label {
				Toggle(
					"Warp Speed",
					isOn: Binding(
						get: { store.warpSettings.superFastModeEnabled },
			...
			Label {
				...
				Spacer()
					Picker("", selection: Binding(
						get: { store.warpSettings.recordingAudioBehavior },
