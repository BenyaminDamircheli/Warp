...
private let pasteboardLogger = WarpLog.pasteboard
...
struct PasteboardClientLive {
    ...
    func paste(text: String) async {
        if warpSettings.useClipboardPaste {
    ...
    func pasteWithClipboard(_ text: String) async {
        ...
        if !warpSettings.copyToClipboard && pasteSucceeded {
        ...
        if !pasteSucceeded && !warpSettings.copyToClipboard {
