...
- **Core Logic**: `WarpCore/Sources/WarpCore/Logic/HotKeyProcessor.swift`
- **Recording Decision**: `WarpCore/Sources/WarpCore/Logic/RecordingDecision.swift`
- **Feature Integration**: `Hex/Features/Transcription/TranscriptionFeature.swift`
- **Tests**: `WarpCore/Tests/WarpCoreTests/HotKeyProcessorTests.swift`
